...
def craft_pkgbuild(info: dict[str, str], source_file: hints.SourceFile) -> hints.PkgbuildFile:
...
def assemble_package(pkgbuild_file: hints.PkgbuildFile, source_file: hints.SourceFile, info: dict[str, str]) -> hints.PackageFile:
  build_dir = os.path.expanduser('~/makepkg/builds')
...
def craft(info: dict[str, str]) -> hints.PackageFile:
  ...
  pkgbuild_file: hints.PkgbuildFile = craft_pkgbuild(info, source_file)
  package_file: hints.PackageFile = assemble_package(pkgbuild_file, source_file, info)
  return package_file
